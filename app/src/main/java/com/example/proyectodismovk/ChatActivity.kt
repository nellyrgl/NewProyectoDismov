...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnRegresar = findViewById<Button>(R.id.btnRegresarChat)
    ...
    private fun initViews(){
        ...
        val sendMessageButton = findViewById<Button>(R.id.btnEnviar)
    ...
    private fun sendMessage(){
        val messageTextField = findViewById<EditText>(R.id.enviarTexto)
        val message = Message(
